      ...
      <div class="container">
        ...
        <div class="row mb-5 justify-content-center">
          <div class="col-md-10 text-center white-gradient">
            ...
            <img src="images/tutorial5.png" width="600px" class="img-fluid" />
            <br />
            <br />
            <p class="ml-3 ml-lg-3 md-3">3.2. Menelusuri iklan dengan menggunakan bar ‘Cari’</p>
            <p
              class="ml-4 ml-lg-4 md-4"
            >Ketikkan kata kunci yang ingin Anda cari (contoh: merek motor/ nama penjual)</p>
            <img src="images/tutorial6.png" width="600px" class="img-fluid" />
            <br />
            <br />
            <p class="ml-3 ml-lg-3 md-3">3.3. Menelusuri iklan dengan menggunakan filter lanjutan</p>
            <p class="ml-4 ml-lg-4 md-4">3.3.1. Buka menu halaman utama dan klik menu ‘Motor Bekas’</p>
            <p class="ml-4 ml-lg-4 md-4">3.3.2. Klik tombol dengan ikon filter di pojok kanan atas</p>
            <p
              class="ml-4 ml-lg-4 md-4"
            >3.3.3. Pilih tombol tipe iklan yang ingin difilter, misalnya "Tawar Bersama"</p>
            <p class="ml-4 ml-lg-4 md-4">3.3.4. Klik tombol ‘Simpan’ untuk menerapkan filter</p>
            <img src="images/tutorial7.png" width="600px" class="img-fluid" />
            <br />
            <br />
            <p class="ml-4 ml-lg-4 md-4">
            ...
            <p class="ml-2 ml-lg-2 md-2 font-weight-bold">4. BERINTERAKSI DENGAN IKLAN</p>
            <p
              class="ml-3 ml-lg-3 md-3"
            >Ketika Anda tertarik dengan sebuah iklan, maka langkah selanjutnya adalah sebagai berikut:</p>
            <p class="ml-3 ml-lg-3 md-3">4.1. Interaksi dengan iklan Harga Pas</p>
            <p class="ml-4 ml-lg-4 md-4">4.1.1. Pilih salah satu iklan Harga Pas yang ingin lihat</p>
            <p
              class="ml-4 ml-lg-4 md-4"
            ...
            <img src="images/tutorial8.png" width="600px" class="img-fluid" />
            <br />
            <br />
            <p
              class="ml-3 ml-lg-3 md-3"
            >4.2. Interaksi dengan iklan Tawar Bersama (TB) yang sedang berlangsung</p>
            <p class="ml-4 ml-lg-4 md-4">4.2.1. Pilih iklan TB yang ingin Anda ikuti.</p>
            <p class="ml-4 ml-lg-4 md-4">4.2.2. Tinjau detail iklan tersebut.</p>
            <p class="ml-4 ml-lg-4 md-4">
            ...
            <img src="images/tutorial9.png" width="600px" class="img-fluid" />
            <br />
            <br />
            <p
              class="ml-4 ml-lg-4 md-4"
            ...
            <img src="images/tutorial10.png" width="600px" class="img-fluid" />
            <br />
            <br />
            <img src="images/tutorial11.png" width="600px" class="img-fluid" />
            <br />
            <br />
            <p class="ml-2 ml-lg-2 md-2 font-weight-bold">5. TIKET</p>

            <p class="ml-3 ml-lg-3 md-3">5.1. Cara Membeli Tiket</p>
            <p class="ml-4 ml-lg-4 md-4">5.1.1. Klik Menu ‘Tiket Tawar Bersama’ di halaman utama</p>
            <p class="ml-4 ml-lg-4 md-4">5.1.2. Klik tombol ‘Beli Tiket’</p>
            <p
              class="ml-4 ml-lg-4 md-4"
            >5.1.3. Klik tombol jumlah tiket atau ketikkan angka jumlah tiket yang ingin Anda beli</p>
            <p class="ml-4 ml-lg-4 md-4">5.1.4. Klik tombol ‘Lanjutkan’ ke pembayaran</p>
            <img src="images/tutorial12.png" width="400px" class="img-fluid" />
            <br />
            <br />
            <img src="images/tutorial13.png" width="400px" class="img-fluid" />
            <br />
            <br />
            <p
              class="ml-4 ml-lg-4 md-4"
            ...
            <img src="images/tutorial14.png" width="800px" class="img-fluid" />
            <br />
            <br />
            <p class="ml-3 ml-lg-3 md-3">5.2. Cara Refund Tiket</p>
            <p
              class="ml-4 ml-lg-4 md-4"
            >5.2.1. Buka menu Tiket Tawar Bersama yang ada di Halaman utama</p>
            <p class="ml-4 ml-lg-4 md-4">5.2.2. Klik tombol ‘Refund Tiket”</p>
            <p
              class="ml-4 ml-lg-4 md-4"
            >5.2.3. Klik tombol jumlah tiket atau ketikkan angka jumlah tiket yang ingin Anda Refund</p>
            <img src="images/tutorial15.png" width="600px" class="img-fluid" />
            <br />
            <br />
            <p
              class="ml-4 ml-lg-4 md-4"
            ...
            <img src="images/tutorial16.png" width="600px" class="img-fluid" />
          </div>
        </div>
      </div>
    </div>
